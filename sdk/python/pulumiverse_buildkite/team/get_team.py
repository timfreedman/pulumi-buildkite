...
def get_team(id: Optional[str] = None,
    ...
    team = buildkite.Team.get_team(id="Everyone")
    ```


    :param str id: The ID of the team to find. Use either ID or slug.
    :param str slug: The slug of the team to find. Use either ID or slug.
    """
    __args__ = dict()
    __args__['id'] = id
    __args__['slug'] = slug
